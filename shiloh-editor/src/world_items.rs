...
pub fn builtin_world_items() -> Vec<WorldItem> {
    vec![
        ...
        WorldItem {
            ...
            name: "Grass Patch",
            category: WorldItemCategory::Foliage,
            description: "Ground cover scatter",
        ...
        WorldItem {
            ...
            description: "Hero boulder for valley floors",
            spawn_name: "Rock_Large",
        },
        WorldItem {
            id: "rock_scatter",
            name: "Rock Scatter",
            category: WorldItemCategory::Props,
            description: "Small stone cluster",
            spawn_name: "Rock_Scatter",
        },
        WorldItem {
            id: "cliff",
            name: "Cliff Face",
        ...
        WorldItem {
            ...
            category: WorldItemCategory::Terrain,
            description: "Terrain chunk placeholder",
